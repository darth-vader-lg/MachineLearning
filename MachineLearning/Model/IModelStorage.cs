...
namespace MachineLearning.Model
{
   ...
   public interface IModelStorage
   {
      ...
      ITransformer LoadModel(IMachineLearningContext context, out DataViewSchema inputSchema);
      /// <summary>
      ...
      /// <param name="inputSchema">Schema di input del modello</param>
      void SaveModel(IMachineLearningContext context, ITransformer model, DataViewSchema inputSchema);
      #endregion
   }
}