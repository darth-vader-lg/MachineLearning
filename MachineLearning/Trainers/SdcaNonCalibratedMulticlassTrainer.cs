...
namespace MachineLearning.Trainers
{
   ...
   /// </summary>
   public partial class SdcaNonCalibratedMulticlassTrainer
   {
      internal class OptionsSurrogate : ISerializationSurrogate
      {
         public void GetObjectData(object obj, SerializationInfo info, StreamingContext context)
         {
            var data = (ML.SdcaNonCalibratedMulticlassTrainer.Options)obj;
         ...
         {
            var data = new ML.SdcaNonCalibratedMulticlassTrainer.Options();
