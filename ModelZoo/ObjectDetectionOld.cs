...
namespace MachineLearning.ModelZoo
{
      ...
      IModelTrainingControl
   {
      ...
      public ObjectDetectionOld(IContextProvider<TFContext> context = default)
      {
   ...
   internal sealed partial class ObjectDetectionOld // Prediction
   {
         ...
         IModelTrainerProvider
      {
         ...
         /// </summary>
         private readonly ObjectDetectionOld _owner;
         /// <summary>
         /// Sessione TensorFlow
         /// </summary>
         ...
         /// </summary>
         public static int MaxTrainingCycles => 1;
         /// <summary>
         /// Storage del modello
         /// </summary>
         ...
         internal Model(ObjectDetectionOld owner, IContextProvider<TFContext> contextProvider = default) : base(contextProvider)
         {
            _owner = owner;
